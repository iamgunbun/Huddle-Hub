...
export default function RecordsPage() {
    ...
    const [activeSubTab, setActiveSubTab] = useState('allTime'); // 'allTime' or 'historical'
    ...
    return (
        <div className={styles.container}>
                                ...
                                <tr key={row.managerId} className={styles.row}>
                                    ...
                                    <td className={styles.managerNameCell}>
                                        <div className={styles.managerCellLayout}>
                                            <img src={resolveImageSrc(row.avatar, '/fallback.png')} alt="Avatar" className={styles.tableAvatar} referrerPolicy="no-referrer" onError={onImageError(row.avatar, '/fallback.png')} />
            ...
            {/* --- SUB-NAVIGATION FILTERS BELOW LEADERBOARD --- */}
            <div className={styles.subNavTabs}>
                <button 
                    className={`${styles.subTabBtn} ${activeSubTab === 'allTime' ? styles.activeSubTab : ''}`}
                    onClick={() => setActiveSubTab('allTime')}
                >
                    ALL-TIME BENCHMARKS
                </button>
                <button 
                    className={`${styles.subTabBtn} ${activeSubTab === 'historical' ? styles.activeSubTab : ''}`}
                                        ...
                                        {(activeDataset.mostSeasonLongPoints || []).slice(0, displayLimit).map((s, i, arr) => {
                                            ...
                                            return (
                                                <tr key={`high-season-${i}`} className={styles.row}>
                                                    ...
                                                    <td>
                                                        <div className={styles.managerCellLayout}>
                                                            <img src={resolveImageSrc(team.avatar, '/fallback.png')} alt="Avatar" className={styles.tableAvatar} referrerPolicy="no-referrer" onError={onImageError(team.avatar, '/fallback.png')} />
                                                            <div className={styles.managerIdentityStack}>
