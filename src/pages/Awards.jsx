                    ...
                    {podiums.map((p, idx) => {
                        ...
                        return (
                            <div key={`champ-${p.year}`} className={`${styles.champCard} ${isReigning ? styles.latestChamp : ''}`}>
                                ...
                                <img src={resolveImageSrc(champTeam.avatar, '/fallback.png')} alt="Champ" className={styles.heroAvatar} referrerPolicy="no-referrer" onError={onImageError(champTeam.avatar, '/fallback.png')} />
            ...
            <div className={styles.wingSection}>
                ...
                <div className={styles.podiumContainer}>
                    ...
                    <div className={`${styles.podiumBlock} ${styles.secondPlace}`}>
                        <img src={resolveImageSrc(p2.avatar, '/fallback.png')} alt="2nd" className={styles.podiumAvatar} referrerPolicy="no-referrer" onError={onImageError(p2.avatar, '/fallback.png')} />
                    ...
                    <div className={`${styles.podiumBlock} ${styles.firstPlace}`}>
                        <img src={resolveImageSrc(p1.avatar, '/fallback.png')} alt="1st" className={styles.podiumAvatar} referrerPolicy="no-referrer" onError={onImageError(p1.avatar, '/fallback.png')} />
                    ...
                    <div className={`${styles.podiumBlock} ${styles.thirdPlace}`}>
                        <img src={resolveImageSrc(p3.avatar, '/fallback.png')} alt="3rd" className={styles.podiumAvatar} referrerPolicy="no-referrer" onError={onImageError(p3.avatar, '/fallback.png')} />
                    ...
                    {podiums.map(p => {
                        ...
                        return (
                            <div key={`shame-${p.year}`} className={styles.shameCard}>
                                ...
                                <img src={resolveImageSrc(toiletTeam.avatar, '/fallback.png')} alt="Loser" className={styles.shameAvatar} referrerPolicy="no-referrer" onError={onImageError(toiletTeam.avatar, '/fallback.png')} />
