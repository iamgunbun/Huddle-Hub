                                    ...
                                    <div className={styles.tradeGrid}>
                                        <div className={styles.tradeColumn}>
                                            <div className={styles.teamHeaderRow}>
                                                <img src={resolveImageSrc(teamA?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} alt="" className={styles.teamAvatar} referrerPolicy="no-referrer" onError={onImageError(teamA?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} />
                                        ...
                                        <div className={styles.tradeColumn}>
                                            <div className={styles.teamHeaderRow}>
                                                <img src={resolveImageSrc(teamB?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} alt="" className={styles.teamAvatar} referrerPolicy="no-referrer" onError={onImageError(teamB?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} />
                            ...
                            <div key={tx.transaction_id} className={styles.txCard}>
                                ...
                                <div className={styles.waiverBody}>
                                    <div className={styles.teamHeaderRowSingle}>
                                        <img src={resolveImageSrc(teamMeta?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} alt="" className={styles.teamAvatar} referrerPolicy="no-referrer" onError={onImageError(teamMeta?.avatar, 'https://sleepercdn.com/images/v2/icons/league_default.webp')} />
