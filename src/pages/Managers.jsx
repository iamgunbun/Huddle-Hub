                ...
                {mergedManagers.map(manager => (
                    ...
                    >
                        <div className={styles.cardHeader}>
                            <img src={resolveImageSrc(manager.teamAvatar, '/fallback.png')} alt="Avatar" className={styles.avatar} referrerPolicy="no-referrer" onError={onImageError(manager.teamAvatar, '/fallback.png')} />
