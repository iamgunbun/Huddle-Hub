import { managers as managersObj } from '../leagueInfo';
import { stringDate } from './news';
import { goto } from '../../svelte-nav-mock';
...
// src/utils/helperFunctions/universalFunctions.js

export const formatOpponent = (opp) => {
