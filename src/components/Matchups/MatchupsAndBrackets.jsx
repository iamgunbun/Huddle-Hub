                                                    ...
                                                    <div key={`bye-${itemIdx}`} className={styles.matchCard}>
                                                        ...
                                                        <div className={`${styles.teamRow} ${styles.byeRow}`}>
                                                            <div className={styles.teamInfo}>
                                                                {meta ? <img src={resolveImageSrc(meta.avatar, '/fallback.png')} className={styles.avatar} alt="bye" referrerPolicy="no-referrer" onError={onImageError(meta.avatar, '/fallback.png')} /> : <div className={styles.avatarPlaceholder} />}
                                            ...
                                            return (
                                                <div key={`match-${roundIdx}-${itemIdx}`} className={styles.matchCard}>
                                                    ...
                                                    <div className={`${styles.teamRow} ${t1.w ? styles.winnerRow : ''}`}>
                                                        <div className={styles.teamInfo}>
                                                            {meta1 ? <img src={resolveImageSrc(meta1.avatar, '/fallback.png')} className={styles.avatar} alt="t1" referrerPolicy="no-referrer" onError={onImageError(meta1.avatar, '/fallback.png')} /> : <div className={styles.avatarPlaceholder} />}
                                                    ...
                                                    <div className={`${styles.teamRow} ${t2.w ? styles.winnerRow : ''}`}>
                                                        <div className={styles.teamInfo}>
                                                            {meta2 ? <img src={resolveImageSrc(meta2.avatar, '/fallback.png')} className={styles.avatar} alt="t2" referrerPolicy="no-referrer" onError={onImageError(meta2.avatar, '/fallback.png')} /> : <div className={styles.avatarPlaceholder} />}
                                            ...
                                            return (
                                                <div key={`cons-card-${cIdx}`} className={styles.matchCard}>
                                                    ...
                                                    <div className={styles.teamRow}>
                                                        <div className={styles.teamInfo}>
                                                            {cmeta1 ? <img src={resolveImageSrc(cmeta1.avatar, '/fallback.png')} className={styles.avatar} alt="ct1" referrerPolicy="no-referrer" onError={onImageError(cmeta1.avatar, '/fallback.png')} /> : <div className={styles.avatarPlaceholder} />}
                                                    ...
                                                    <div className={styles.teamRow}>
                                                        <div className={styles.teamInfo}>
                                                            {cmeta2 ? <img src={resolveImageSrc(cmeta2.avatar, '/fallback.png')} className={styles.avatar} alt="ct2" referrerPolicy="no-referrer" onError={onImageError(cmeta2.avatar, '/fallback.png')} /> : <div className={styles.avatarPlaceholder} />}
